    ...
    This version does NOT scale to the number of players, so the number of squads spawned is configured in the init box code used
        ...
        Syntax:
          handle = [
                    ...
                    ]  execVM "scripts\spawnInfSqd.sqf";

                Example: handle = [this, ["spawnMarker1","spawnMarker2"], 6, 12, 3, "CSAT",["WP1a","WP1b","WP1c","WP1d","WP1e","WP1f","WP1z"]]  execVM "scripts\spawnInfSqd.sqf";
...
private ["_rndSpd","_rndBhv","_rndTO","_rndForm","_rndType","_rnd","_units","_squadInf","_HostileSquadMinBase","_HostileSqdMaxBase","_DifficultyFactor","_HostileSquadRange","_spawnPt","_size","_spawnee","_faction","_sqdFactor","_numSqds"];
